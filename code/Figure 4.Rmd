...
pdf(file = "../figures/Figure4A.pdf", width = 5, height = 10)
...
rect_list_1 <- rep(list(element_rect(fill = "#457cd6")), 2)
...
p <- ggplot(data_plot) +
  facet_wrap2(
    signature~Assay, ncol = 7, scales = "free_y",
...
ggsave(p_fixed, filename = "../figures/Figure4B.pdf", width = 14, height = 11)
