...
pdf(file = "../figures/Figure4A.pdf", width = 10, height = 4)
...
pdf("../figures/Figure4B.pdf", width = 5, height = 5)
plot(
  roc_obj,
  col = "#1c61b6",
...
pdf(file = "../figures/Figure4C.pdf",width = 6, height = 4)
print(p)
invisible(dev.off())
...
ggsave(p_fixed, filename = "../figures/Figure4D.pdf", width = 5, height = 5)

rm(data_plot, p, width_in_cm, height_in_cm, p_fixed, background_fill) # cleanup
```
