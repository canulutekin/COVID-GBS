...
pdf(file = "../figures/FigureS5A.pdf", width = 6, height = 6)
...
ggsave(p_fixed, filename = "../figures/FigureS5B.pdf", width = 14, height = 11)
...
ggsave(p_fixed, filename = "../figures/FigureS5C.pdf", width = 14, height = 11)
